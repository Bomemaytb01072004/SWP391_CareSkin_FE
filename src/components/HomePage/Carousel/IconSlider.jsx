...
function IconSlider() {
  const settings = {
    ...
    slidesToShow: 6, // Default number of logos visible at once
    slidesToScroll: 1,
    autoplay: true,
    ...
    arrows: false,
    responsive: [
      { breakpoint: 1024, settings: { slidesToShow: 5 } }, // Medium screens
      { breakpoint: 768, settings: { slidesToShow: 4 } }, // Tablets
      { breakpoint: 480, settings: { slidesToShow: 3 } }, // Mobile
    ],
  };
  ...
  const brandLogos = [
    ...
    { src: '/src/assets/brands/estee-lauder.jpg', alt: 'Estée Lauder' },
    { src: '/src/assets/brands/clinique.png', alt: 'Clinique' },
    { src: '/src/assets/brands/the-ordinary.png', alt: 'The Ordinary' },
    { src: '/src/assets/brands/fenty-beauty.webp', alt: 'Fenty Beauty' },
  ...
  return (
    <div className="max-w-full bg-emerald-50 py-6">
