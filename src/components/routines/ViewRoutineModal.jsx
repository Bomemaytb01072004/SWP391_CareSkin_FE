...
import { X, Plus, ArrowDownCircle, ArrowUpCircle, Trash, Save, ShoppingBag } from 'lucide-react';
...
const ViewRoutineModal = ({ isOpen, onClose, routineId, refetchRoutines }) => {
  ...
  const handleMoveStep = async (stepId, direction) => {
    ...
    try {
      ...
      console.log('Moving step', stepToMove.StepOrder, 'to', otherStep.StepOrder);
      ...
      await updateRoutineStep(otherStep.RoutineStepId, {
        ...otherStep,
        StepOrder: stepToMove.StepOrder
      });
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
      <div className="relative bg-gray-800 text-white rounded-lg shadow-xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="bg-gray-700 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-white">{routine?.RoutineName}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm">Period:</p>
                  <p className="text-white capitalize">{routine?.RoutinePeriod}</p>
                </div>
                <div>
                  <p className="text-gray-400 text-sm">Skin Type:</p>
                  <p className="text-white">{routine?.SkinTypeName}</p>
                </div>
                <div>
            ...
            <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2 bg-gray-600 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-1">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-2 bg-gray-600 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white h-20"
                    ...
                    <div className="flex justify-end pt-2">
                      <button
                        ...
                        className="px-3 py-1 bg-gray-600 text-white rounded-md mr-2 hover:bg-gray-500 text-sm"
                      >
                        Cancel
                      </button>
                      <button
              ...
              {steps.length === 0 ? (
                <div className="text-center py-8 bg-gray-700 rounded-lg">
                  <p className="text-gray-400">No steps added yet. Add your first step to get started.</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {steps.map((step, index) => (
                    <div key={step.RoutineStepId} className="bg-gray-700 rounded-lg overflow-hidden">
                      <div className="bg-gray-600 p-3 flex justify-between items-center">
                        ...
                        <div className="flex space-x-1">
                          <button
                            ...
                            disabled={index === 0}
                            className={`p-1 rounded ${index === 0 ? 'text-gray-500 cursor-not-allowed' : 'text-blue-400 hover:bg-gray-500'}`}
                            title="Move Up"
                          >
                          ...
                          <button
                            ...
                            className={`p-1 rounded ${index === steps.length - 1 ? 'text-gray-500 cursor-not-allowed' : 'text-blue-400 hover:bg-gray-500'}`}
                            title="Move Down"
                          >
                          ...
                          <button
                            ...
                            className="p-1 rounded text-red-400 hover:bg-gray-500"
                            title="Delete Step"
                          >
                            <Trash size={16} />
                          </button>
                      ...
                      <div className="p-4">
                        ...
                        <div className="mt-4">
                          <div className="flex justify-between items-center mb-3">
                            <h6 className="text-sm font-medium text-gray-300">Products in this step</h6>
                            <button
                              ...
                              <div className="space-y-3">
                                ...
                                <div>
                                  ...
                                  <textarea
                                    ...
                                    className="w-full px-3 py-2 bg-gray-700 border border-gray-500 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-white text-sm h-16"
                                ...
                                <div className="flex justify-end">
                                  <button
                                    ...
                                    className="px-3 py-1 bg-gray-500 text-white rounded-md mr-2 hover:bg-gray-400 text-xs"
                                  >
                                    Cancel
                                  </button>
                                  <button
                          ...
                          {products[step.RoutineStepId]?.length > 0 ? (
                            <div className="space-y-2">
                              {products[step.RoutineStepId].map((product) => (
                                <div key={product.RoutineProductId} className="flex justify-between items-center p-2 bg-gray-600 rounded">
                                  <div className="flex items-center">
                                    ...
                                    <div>
                                      ...
                                      {product.Product && (
                                        <div className="mt-2 flex items-center">
                                          ...
                                          <div>
                                            <p className="text-xs text-green-400">{product.Product.Category || product.ProductCategory}</p>
                            ...
                            <p className="text-xs text-gray-400 italic">No products added to this step yet</p>
                          )}
                        </div>
                      </div>
                    </div>
